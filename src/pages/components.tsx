          ...
          >
            ...
            <ol className="mt-8 space-y-6">
              ...
              <li className="space-y-2">
                ...
                <div className="space-x-2">
                  <IconButton variant="light" icon={HiTrash} />
                  <IconButton variant="light" icon={HiTrash} disabled />
                </div>
                <div className="space-x-2">
                  <IconButton variant="outline" icon={HiTrash} />
                  <IconButton variant="outline" icon={HiTrash} disabled />
                </div>
                <div className="space-x-2">
                  <IconButton variant="ghost" icon={HiTrash} />
                  <IconButton variant="ghost" icon={HiTrash} disabled />
                </div>
                <div className="space-x-2">
